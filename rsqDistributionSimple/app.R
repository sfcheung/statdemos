    ...
    fluidRow(
      column(12,
        wellPanel(
            ...
            p("2. Set the population B1 (Slope)."),
            p("3. Click 'Update the Plots'."),
            p("4. Examine the plots."),
            p("(Changing the population B0 is optional.)")
        ))),
    fluidRow(
        ...
        wellPanel(
          ...
          p("The latest version of the code can be found at ",
            a("statdemos at GitHub",
              href = "https://github.com/sfcheung/statdemos/tree/master/rsqDistributionSimple"),
              "."
            ),
          p("This app can be run directly by ",
            code("shiny::runUrl(\"https://github.com/sfcheung/statdemos/raw/master/apps/rsqDistributionSimple.zip\")")
            ),
